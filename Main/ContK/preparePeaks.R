####################
#### TITLE:     Prepare peak locations for meta-analysis
#### Contents:
####
...
#source_url('https://raw.githubusercontent.com/NeuroStat/FixRanHan/ClusterInferenceALE/Development/functions.R?token=AHRuDehluGCj0KJtGIvvsqisFnTFQRYBks5X83ZSwA%3D%3D',sha1='fc3e0d355e4ca22907d676cb5bde3b18b7059a53')
source('/user/scratch/gent/gvo000/gvo00022/vsc40728/NoReplacement/functions.R')

	# Print which libraries are needed
	print("Need R file: functions.R and devtools library")
