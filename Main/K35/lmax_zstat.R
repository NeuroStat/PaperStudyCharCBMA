...
# This file is needed to get local maxima from the individual studies as input into the coordinate based meta-analyses.
...
# Take arguments from main_CBMA_K35.sh
