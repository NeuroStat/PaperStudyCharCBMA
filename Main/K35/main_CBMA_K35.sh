...
#### Contents:
####
#### Source Files: //Meta\ Analyis/R\ Code/Studie_CBMA/PaperStudyCharCBMA.git/Main/K35
#### First Modified: 27/09/2016 (K = 35 version, based on K = 10 version of 13/11/2014)
#################
...
SCRPT=PaperStudyCharCBMA/Main/K35
...
cd "${SCRPT}"
Rscript "${SCRPT}"/LoadSubjK35.R "$Studies" "$RUN" "$SCRPT" &> ROutput_SamplingCrossVal.txt
