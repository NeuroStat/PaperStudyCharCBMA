####################
#### TITLE:     Sample subjects in K = 35 studies.
#### Contents:
####
...
# We have to sample 700 subjects each time.
...
# This should be loaded in the main_CBMA_K35.sh file.
...
wd <- 'PaperStudyCharCBMA/Main/K35'
setwd(wd)
...
save(StudySamSubj, file = paste(wd,'/StudySamSubjK35.RData',sep=''))

# Subjects in the Ref
save(RefSamSubj, file = paste(wd,'/RefSamSubjK35.RData',sep=''))
